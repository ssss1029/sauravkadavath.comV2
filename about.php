				...
				<!-- Main -->
					<div id="main">
                        ...
                        <section class="post">
                            ...
                            <p>Hey there! I'm an Electrical Engineering &amp; Computer Science major at UC Berkeley (possibly also a math minor; we'll see I guess). I'm using this website as a way for to keep track of all the problems that I encounter on my computing adventures - and hopefully it also helps out anyone who is trying to do some similar stuff.</p>
                            ...
                            <p>Some of my past projects include <a href="polisight.php">Polisight</a> and <a href="rummage.php">Rummage</a></p>
                        </section>
                    </div>
